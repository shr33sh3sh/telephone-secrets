...
for FILE in "${DOCKERFILES[@]}"; do
  ...
  # If Dockerfile is in root → use just PARENT_NAME
  # Otherwise → use subdirectory name as component
  ...
  SERVICE_NAME="${PARENT_NAME}${IMAGE_SUFFIX}-service"

  # Standard deployment for ALL services (including any "cli" directory)
...
EOF
  ...
  echo "  Generated manifests for: ${COMPONENT_NAME} (port: $PORT)"
